...
**! Для запуска примеров кода необходимо добавить в эту папку сертификаты, или изменить пути к файлам в коде**

** примеры правильных путей для работоспособности примеров после добавления сертификатов:** 
``` 
 ...
 - .....
 - ...../Certficates/certificate.crt - сертификат
 - ...../Certficates/install_certificate.pfx - установочный файл для установки на локальный компьютер (с закртым ключом)
```
