...
namespace Midway.ObjectModel.Utility
{
	...
	public class FullEnumValuesRequest : EnumValuesRequest
	{
		...
		/// <summary>
		/// <c>true</c>, если требуется получить значения перечисления типа 'Версия формата титула экспедитора транспортной накладной'; иначе - <c>false</c>.
		/// </summary>
		[DataMember]
		public bool WithTransportWaybillExpeditorTitleFormatVersions { get; set; }

		/// <summary>
		/// <c>true</c>, если требуется получить значения перечисления типа 'Версия формата титула смены водителя и/или ТС транспортной накладной'; иначе - <c>false</c>.
		/// </summary>
		[DataMember]
		public bool WithTransportWaybillDriverOrVehicleChangeTitleFormatVersions { get; set; }
